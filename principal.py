...
def main():
        ...
        #Carga icono
        icono = pygame.image.load("mago.png")
        pygame.display.set_icon(icono)

        #Cargar imagen de fondo
        background = pygame.image.load("magofondo.jpg")
        reglas = pygame.image.load("reglas.jpg")
        background_inicio = pygame.image.load("rickandmorty.jpg")

        #Carga de sonidos
        acierto = pygame.mixer.Sound("acierto.wav")
        fallo = pygame.mixer.Sound("fallo.wav")
        inicio = pygame.mixer.Sound("juego.mp3")
