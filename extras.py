...
def dibujar(screen, palabraUsuario, palabraActual, puntos, segundos):
    fin = pygame.mixer.Sound("gameover.wav")
...
def menuYReglas(bandera,bandera2,bandera3, screen):
    while bandera == True:
        background_inicio = pygame.image.load("rickandmorty.jpg")  #Se carga el fondo
    ...
    while bandera == False and bandera2 == True:
        reglas = pygame.image.load("reglas.jpg")
    ...
    while bandera == False and bandera2 == False and bandera3 == True:
            ...
            score_fondo = pygame.image.load("score.jpg")
            ...
            scores=defaultFont.render("1.   " + lista_scores[4],True,COLOR_CONF)
            users=defaultFont.render(lista_users[4],True,COLOR_CONF)
            scores2=defaultFont.render("2.   " + lista_scores[3],True,COLOR_CONF)
            users2=defaultFont.render(lista_users[2],True,COLOR_CONF)
            scores3=defaultFont.render("3.   " + lista_scores[2],True,COLOR_CONF)
            users3=defaultFont.render(lista_users[2],True,COLOR_CONF)
            scores4=defaultFont.render("4.   " + lista_scores[1],True,COLOR_CONF)
            users4=defaultFont.render(lista_users[1],True,COLOR_CONF)
            scores5=defaultFont.render("5.   " + lista_scores[0],True,COLOR_CONF)
